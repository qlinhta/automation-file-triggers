...
category = {"Audios": [".aif", ".cda", ".mid", ".mp3", ".mpa", ".ogg", ".wav", ".wma", ".wpl", ".midi", ".pkf"],
            ...
            "Documents": [".bin", ".dmg", ".iso", ".toast", ".vcd", ".csv", ".dat", ".db", ".log", ".mdb", ".sav",
                          ...
                          ".docx", ".aspx", ".html", ".PDF" ],
            "Images": [".ai", ".bmp", ".gif", ".ico", ".jpeg", ".png", ".ps", ".psd", ".svg", ".tif", ".jpg", ".tiff", ".HEIC", ".JPG", ".PNG", ".JPEG", ".heic"],
            "Videos": [".3g2", ".3gp", ".avi", ".flv", ".h264", ".m4v", ".mkv", ".mov", ".mp4", ".mpg.rm", ".swf",
                       ".vob", ".wmv", ".mpeg", ".webm"],
            "Scripts": [".R", ".terminal", ".ipynb"],
